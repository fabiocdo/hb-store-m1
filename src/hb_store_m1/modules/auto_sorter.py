...
# from hb_store_m1.models import SorterPlanResult
#
#
# class AutoSorter:
#
...
#             log(
#                 "debug",
#                 "Skipping sort. PKG is already in the folder",
#                 message=f"{target_dir}",
#                 module="AUTO_SORTER",
#             )
#             return None
#
...
#             log(
#                 "error",
#                 "Failed to move PKG. Target already exists",
#                 message=f"{pkg.name}",
#                 module="AUTO_SORTER",
#             )
...
#                 message=f"{pkg.name} -> {conflict_path.name}",
#                 module="AUTO_SORTER",
#             )
#             return None
#
...
#         log(
#             "info",
#             "PKG sorted successfully",
#             message=f"{pkg.name} -> {target_path}",
#             module="AUTO_SORTER",
#         )
