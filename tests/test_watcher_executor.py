...
#
# from hb_store_m1.modules.helpers.watcher_executor import WatcherExecutor
...
#         return (
#             WatcherExecutor(pkg_utils, formatter, sorter),
#             pkg_utils,
#             formatter,
#             sorter,
#         )
...
#             with patch.dict(
#                 os.environ,
#                 {"ERROR_DIR": str(error_dir), "LOG_DIR": str(log_dir)},
#                 clear=False,
#             ):
#                 results = [
#                     {
...
#                         "pkg": {
#                             "planned_path": str(pkg_path),
#                             "action": PlanOutput.ALLOW,
#                         },
#                         "icon": {
#                             "planned_path": str(icon_path),
#                             "action": PlanOutput.ALLOW,
#                         },
#                     }
#                 ]
...
#                         "icon": {
#                             "planned_path": str(Path(tmp_dir) / "i.png"),
#                             "action": PlanOutput.SKIP,
#                         },
#                     },
#                     {
#                         "source": str(pkg3),
