...
#         pkg = MagicMock(spec=Path)
#         with patch.object(
#             AutoSorter, "dry_run", return_value=(AutoSorter.PlanResult.NOT_FOUND, None)
#         ):
...
#         with patch.object(
#             AutoSorter, "dry_run", return_value=(AutoSorter.PlanResult.SKIP, target_dir)
#         ):
#             result = self.sorter.run(pkg, "game")
#             self.assertIsNone(result)
#             pkg.rename.assert_not_called()
...
#                     "dry_run",
#                     return_value=(
#                         AutoSorter.PlanResult.CONFLICT,
#                         Path("/data/pkg/game"),
#                     ),
#                 ):
#                     result = self.sorter.run(pkg, "game")
...
#
#         with patch.object(
#             AutoSorter, "dry_run", return_value=(AutoSorter.PlanResult.OK, target_dir)
#         ):
#             result = self.sorter.run(pkg, "game")
