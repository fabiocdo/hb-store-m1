...
#             self.assertEqual(
#                 payload["cover_url"], "http://localhost:8080/pkg/_media/icon.png"
#             )
#
...
#             self.assertEqual(
#                 md5_path.read_text(encoding="utf-8"), "1108b4621259e8634b68d2453ef49c74"
#             )
#             self.assertTrue(json_path.exists())
#             self.assertEqual(
#                 json_path.read_text(encoding="utf-8"),
#                 '{"hash": "1108b4621259e8634b68d2453ef49c74"}',
#             )
#
#
