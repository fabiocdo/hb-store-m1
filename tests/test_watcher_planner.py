...
#         return (
#             WatcherPlanner(pkg_utils, formatter, sorter),
#             pkg_utils,
#             formatter,
#             sorter,
#         )
...
#             with patch(
#                 "src.modules.helpers.watcher_planner.scan_pkgs",
#                 return_value=([], False),
#             ):
...
#                 with patch(
#                     "src.modules.helpers.watcher_planner.scan_pkgs",
#                     return_value=(scan_results, True),
#                 ):
#                     results, sfo_cache = planner.plan()
#
...
#         planner, pkg_utils, formatter, sorter = self._make_planner()
#         formatter.dry_run.return_value = (
#             AutoFormatter.PlanResult.CONFLICT,
#             "conflict.pkg",
#         )
#         sorter.dry_run.return_value = (AutoSorter.PlanResult.OK, Path("/tmp"))
#         pkg_utils.extract_pkg_icon.return_value = None
...
#                 pkg_path.touch()
#                 sorter.dry_run.return_value = (
#                     AutoSorter.PlanResult.SKIP,
#                     pkg_path.parent,
#                 )
