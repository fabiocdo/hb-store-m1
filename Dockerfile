...
COPY docker/nginx/nginx.template.conf /app/init/nginx.template.conf
COPY docker/nginx/index.html /app/init/index.html
COPY assets/512.png /app/init/assets/512.png
...
RUN chmod +x /entrypoint.sh \
 ...
 && mkdir -p /app/configs /app/configs/certs
